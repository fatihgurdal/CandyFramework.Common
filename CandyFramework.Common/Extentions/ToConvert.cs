    ...
    public static class ToConvert
    {
        ...
        public static List<T> ToList<T>(this DataTable datatable) where T : new()
        {
            ...
            try
            {
                ...
                Temp = datatable.AsEnumerable().ToList().ConvertAll<T>(row => ToObject<T>(row, columnsNames));
                return Temp;
            }
            catch
            {
        ...
        public static T ToObject<T>(this DataRow row, List<string> columnsName) where T : new()
        {
            var obj = new T();
            try
            {
        ...
        public static TResult Convert<TRequest, TResult>(this TRequest objRequest)
            where TResult : new()
        {
